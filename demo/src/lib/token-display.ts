export function colorForToken(token: number) {
  ...
  return {
    ...
    labelGradientLight: `linear-gradient(135deg, ${labelLightHighlight} 0%, ${labelLightBase} 100%)`,
    labelGradientDark: `linear-gradient(135deg, ${labelDarkHighlight} 0%, ${labelDarkBase} 100%)`,
