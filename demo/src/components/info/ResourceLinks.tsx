  ...
  return (
    <Card>
      ...
      <CardContent className="gap-5">
        <div className="rounded-2xl border border-slate-200/70 bg-white/95 p-4 text-sm text-slate-600 shadow-sm dark:border-slate-800/70 dark:bg-slate-950/80 dark:text-slate-300">
          <p>
            • Read the{' '}
            <a
