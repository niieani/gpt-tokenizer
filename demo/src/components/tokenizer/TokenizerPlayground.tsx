            ...
            <button
              ...
              className={cn(
                ...
                showTokenIds
                  ...
                  : 'border-slate-200/70 bg-white/95 text-slate-600 hover:bg-slate-100 dark:border-slate-800/70 dark:bg-slate-950/80 dark:text-slate-200 dark:hover:bg-slate-950/70',
              )}
